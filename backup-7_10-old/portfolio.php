                ...
                <div class="table">
                    <div class="table-cell">
                        <figure class="image-frame grey">
                            <a href="http://www.jennajasonwedding.com" rel="external"><img src="/img/jenna-jason-wedding.png" /></a>
                        </figure>
                        <h3 class="porfolio-title"><a href="http://www.jennajasonwedding.com" rel="external">Jacobson Wedding</a></h3>
                    </div>
                    <div class="table-cell">
                        <figure class="image-frame grey">
